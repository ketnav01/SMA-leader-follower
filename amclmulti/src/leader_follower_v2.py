...
if __name__ == "__main__":
    ...
    rospy.init_node(str(sys.argv[3]))
    r = rospy.Rate(0.5) 
    tb0_sub = rospy.Subscriber(robot1_pose, PoseWithCovarianceStamped, tb0_get_rotation) # geometry_msgs/PoseWithCovariance pose
    tb1_sub = rospy.Subscriber(robot2_pose, PoseWithCovarianceStamped, tb1_get_rotation)
